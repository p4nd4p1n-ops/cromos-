#!/usr/bin/env python3
"""scan_liquidez_b5.py — liquidez de 6 candidatas más (Select/Chronicles/Prizm Dominance/Revolution)."""
...
CARTAS = [
    ("LeBron Select 20-21 #23", "https://www.comc.com/Cards/Basketball/2020-21/Panini_Select_-_Base/23/Concourse_-_LeBron_James/17362929"),
    ("LeBron Chronicles 19-20 #689", "https://www.comc.com/Cards/Basketball/2019-20/Panini_Chronicles_-_Base/689/Rookies_and_Stars_-_LeBron_James/15872963"),
    ("LeBron Prizm Dominance 20-21", "https://www.comc.com/Cards/Basketball/2020-21/Panini_Prizm_-_Dominance/17/LeBron_James/16859340"),
    ("Curry Revolution 24-25 #6", "https://www.comc.com/Cards/Basketball/2024-25/Panini_Revolution_-_Base/6/Stephen_Curry/29017382"),
    ("LeBron Donruss Magicians 21-22", "https://www.comc.com/Cards/Basketball/2021-22/Panini_Donruss_-_Magicians/3/LeBron_James/18590829"),
    ("Bronny Donruss X-Pectations 24-25", "https://www.comc.com/Cards/Basketball/2024-25/Panini_Donruss_-_Great_X-Pectations/14/Bronny_James_Jr/28158419"),
]
...
def main():
    ...
    out = {"fecha": datetime.datetime.now().strftime("%Y%m%d-%H%M%S"), "tipo": "pm-b5", "cartas": []}
    ...
    json.dump(out, open(f"{DATA}/pm-b5-{out['fecha']}.json", "w"), ensure_ascii=False, indent=1)
    print("OK", flush=True)
