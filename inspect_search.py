#!/usr/bin/env python3
"""Inspeccionar HTML de búsqueda COMC: cómo se enlaza al jugador."""
...
html = get("https://www.comc.com/Search.aspx?search=" + urllib.parse.quote("Stephon Castle"))
# buscar TODOS los href con Players o cID
players = re.findall(r'href="([^"]*Players[^"]*)"', html)
print("enlaces Players:", len(players))
for p in sorted(set(players))[:10]:
    print("  ", p)
# también buscar patrones c\d+ genéricos
cids = re.findall(r'c\d{4,}', html)
print("cIDs:", sorted(set(cids))[:10])
