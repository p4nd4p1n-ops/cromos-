#!/usr/bin/env python3
"""Debug: ver todos los links Prizm base de Jalen Green en su página de jugador."""
...
# página de jugador de Jalen Green con filtro Prizm 2021-22
url = "https://www.comc.com/Players/Basketball/Jalen_Green/373997/Cards/Basketball/2021-22/Panini_Prizm,sh,i100"
html = get(url)
m = re.search(r"<title>([^<]+)</title>", html)
print("title:", m.group(1).strip() if m else "?")
links = re.findall(r'href="(/Cards/Basketball/2021-22/Panini_Prizm[^"]*)"', html)
