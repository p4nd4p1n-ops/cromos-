#!/usr/bin/env python3
"""GetCardPopupNew con headers AJAX correctos (Content-Type json + X-Requested-With).
11/08/2026.
"""
...
# POST con headers de AJAX ASP.NET
url = "https://www.comc.com/CardPopupService.asmx/GetCardPopupNew"
post = json.dumps({"sourceElement": "none", "productKey": "28874190 0 "})
d = fs({"cmd": "request.post", "url": url,
        "postData": post,
        "headers": {"Content-Type": "application/json; charset=utf-8",
                    "X-Requested-With": "XMLHttpRequest",
                    "Referer": "https://www.comc.com/Cards/Football/2024/Panini_Donruss_Optic_-_Base/248/Rated_Rookie_-_Jayden_Daniels/28874190"},
        "maxTimeout": 60000, "session": "ghost", "cookies": COOKIES})
