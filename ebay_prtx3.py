#!/usr/bin/env python3
"""ebay_prtx3.py — sigue los links eBay_Auction restantes de PRTX560 (3113226, 3113251, 3113974)."""
...
links = [
    "/Promotions/eBay_Auction/PRTX560/eBay_Auction/3113226",
    "/Promotions/eBay_Auction/PRTX560/eBay_Auction/3113251",
    "/Promotions/eBay_Auction/PRTX560/eBay_Auction/3113974",
]
...
for l in links:
    try:
        ...
        print(f"{l} -> {title[:110]}  itemId={itm.group(1) if itm else '?'}")
        if "Knueppel" in title:
            open("/tmp/ebay_knueppel.html", "w").write(resp)
            print("  >>> ¡KNUEPPEL ENCONTRADO! guardado")
