#!/usr/bin/env python3
"""Prueba GetCardPopupNew — el popup de la carta con TODOS los sellers.
productKey = '<cardId> 0 ' segun TOOLS.md. 11/08/2026.
"""
...
# POST al servicio como lo haria la web
url = "https://www.comc.com/CardPopupService.asmx/GetCardPopupNew"
body = {"sourceElement": "none", "productKey": "28874190 0 "}
d = fs({"cmd": "request.post", "url": url, "postData": json.dumps(body),
