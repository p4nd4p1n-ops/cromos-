#!/usr/bin/env python3
"""scan_liquidez_b4.py — liquidez de 6 candidatas más (Hoops/Donruss/Revolution/Prizm DP)."""
...
CARTAS = [
    ("Edgecombe Hoops 25-26 #244", "https://www.comc.com/Cards/Basketball/2025-26/Topps_NBA_Hoops_-_Base/244/VJ_Edgecombe/32803358"),
    ("Curry Donruss 23-24 #65", "https://www.comc.com/Cards/Basketball/2023-24/Panini_Donruss_-_Base/65/Stephen_Curry/24856419"),
    ("Curry Hoops Tribute 22-23", "https://www.comc.com/Cards/Basketball/2022-23/Panini_NBA_Hoops_-_Base/294/Hoops_Tribute_-_Stephen_Curry/22003291"),
    ("LeBron Revolution 24-25 #31", "https://www.comc.com/Cards/Basketball/2024-25/Panini_Revolution_-_Base/31/LeBron_James/29017407"),
    ("Curry Chronicles Xr 20-21", "https://www.comc.com/Cards/Basketball/2020-21/Panini_Chronicles_-_Base/282/Xr_-_Stephen_Curry/17891804"),
    ("Wemby Prizm Draft Picks #99", "https://www.comc.com/Cards/Basketball/2024-25/Panini_Prizm_Draft_Picks_-_Base/99/Victor_Wembanyama/27621952"),
]
...
def main():
    ...
    out = {"fecha": datetime.datetime.now().strftime("%Y%m%d-%H%M%S"), "tipo": "pm-b4", "cartas": []}
    ...
    json.dump(out, open(f"{DATA}/pm-b4-{out['fecha']}.json", "w"), ensure_ascii=False, indent=1)
    print("OK", flush=True)
