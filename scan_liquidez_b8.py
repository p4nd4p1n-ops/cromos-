#!/usr/bin/env python3
"""scan_liquidez_b8.py — liquidez de Topps Now / Bowman premium (Flagg, Knueppel)."""
...
CARTAS = [
    ("Knueppel Bowman #4", "https://www.comc.com/Cards/Basketball/2025-26/Bowman_-_Base/4/Kon_Knueppel/30579238"),
    ("Flagg Topps Now Draft D1", "https://www.comc.com/Cards/Basketball/2025-26/Topps_Now_Draft_-_Online_Exclusive_Base/D1/Cooper_Flagg/31620410"),
    ("Flagg Bowman #1", "https://www.comc.com/Cards/Basketball/2025-26/Bowman_-_Base/1/Cooper_Flagg/30579235"),
    ("Knueppel Topps Now #152", "https://www.comc.com/Cards/Basketball/2025-26/Topps_Now_-_Online_Exclusive_Base/152/Kon_Knueppel/31620410"),
    ("Flagg Topps Now #241", "https://www.comc.com/Cards/Basketball/2025-26/Topps_Now_-_Online_Exclusive_Base/241/Cooper_Flagg/31620410"),
    ("Flagg Topps Now #150", "https://www.comc.com/Cards/Basketball/2025-26/Topps_Now_-_Online_Exclusive_Base/150/Cooper_Flagg/31620410"),
]
...
def main():
    ...
    out = {"fecha": datetime.datetime.now().strftime("%Y%m%d-%H%M%S"), "tipo": "pm-b8", "cartas": []}
    ...
    json.dump(out, open(f"{DATA}/pm-b8-{out['fecha']}.json", "w"), ensure_ascii=False, indent=1)
    print("OK", flush=True)
